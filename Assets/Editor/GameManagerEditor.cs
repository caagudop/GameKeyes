...
public class GameManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        //SerializedProperty greenDoor = serializedObject.FindProperty("m_GreenDoor");
        //EditorGUILayout.PropertyField(greenDoor);
        //SerializedProperty greenSceneName = serializedObject.FindProperty("greenSceneName");
        //EditorGUILayout.PropertyField(greenSceneName);

        //SerializedProperty redSceneName = serializedObject.FindProperty("redSceneName");
        //EditorGUILayout.PropertyField(redSceneName);
        ...
        //EditorGUILayout.PropertyField(yellowSceneName);
        ...
        greenStr = EditorGUILayout.TextField(greenStr, GUILayout.MinWidth(50), GUILayout.MaxWidth(125));
        ...
        redStr = EditorGUILayout.TextField(redStr, GUILayout.MinWidth(50), GUILayout.MaxWidth(125));
        ...
        blueStr = EditorGUILayout.TextField(blueStr, GUILayout.MinWidth(50), GUILayout.MaxWidth(125));
        ...
        yellowStr = EditorGUILayout.TextField(yellowStr, GUILayout.MinWidth(50), GUILayout.MaxWidth(125));
